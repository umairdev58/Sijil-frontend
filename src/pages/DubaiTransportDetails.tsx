...
const DubaiTransportDetails: React.FC = () => {
  ...
  const handleAddPayment = async () => {
    ...
    try {
      const response = await apiService.addDubaiTransportPayment(id!, {
      ...
      <Box sx={{ p: 3 }}>
        ...
        <Box sx={{ mb: 3, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <Stack direction="row" spacing={2} alignItems="center">
            <IconButton onClick={() => navigate('/dubai-transport-invoices')}>
              <ArrowBackIcon />
            </IconButton>
            <Typography variant="h4" component="h1">
              Dubai Transport Invoice Details
            </Typography>
          </Stack>
          <Stack direction="row" spacing={2}>
            ...
            <Button
              variant="contained"
              startIcon={<EditIcon />}
              onClick={() => navigate(`/dubai-transport-invoices/${id}/edit`)}
            >
              Edit Invoice
            </Button>
          </Stack>
...
export default DubaiTransportDetails;
